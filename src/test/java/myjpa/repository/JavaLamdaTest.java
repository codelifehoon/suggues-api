...
import myjpa.core.util.RandomUti;
...
//        http://localhost:8080/User/User/FindAll/pageAuto
    ...
    public void restTemplateTest()
    {
        ...
        String forObject = restTemplate.getForObject("http://localhost:8080/User/User/FindAll/pageAuto", String.class);

        log.debug(forObject.toString());

        log.debug(("availableProcess : " + Runtime.getRuntime().availableProcessors() ));
    }
