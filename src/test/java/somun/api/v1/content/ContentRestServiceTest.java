...
public class ContentRestServiceTest {
    ...
    public  void findEventList(){
        ...
        String content = this.restTemplate
    ...
    public void updateContent () {
        ...
        EventContent eventContent = EventContent.builder().userHash(RandomUti.randomString(9))
                                                ...
                                                .stat(Codes.EV_STAT.S2)
                                                .build();
        Integer content = restTemplate.exchange("/Content/V1/updateContent/105", HttpMethod.POST
            , new HttpEntity(eventContent, requestHeaders)
    ...
    public void updateContentStat () {
        ...
        Integer content = restTemplate.exchange("/Content/V1/updateContentStat/108/" + Codes.EV_STAT.S4, HttpMethod.PATCH
    ...
    public void UpdateContentComment_member () {
        ContentComment build = ContentComment.builder().commentDesc("업데이트"+RandomUti.randomString(10))
                                             ...
                                             .build();
        Integer body = restTemplate.exchange("/Content/V1/updateContentComment", HttpMethod.PATCH
            , new HttpEntity(build, requestHeaders)
            , Integer.class)
                                   .getBody();
        new LogUtil().printObject(body);
    ...
    public void findContentForContentMain(){
        EventContentWithUser body = restTemplate.exchange("/Content/V1/findContentForContentMain/105"
            , HttpMethod.GET
            , null
    ...
    public void deleteContentComment(){
        Integer body = restTemplate.exchange("/Content/V1/deleteContentComment/70"
            , HttpMethod.PATCH
            , new HttpEntity(null, requestHeaders)
            , Integer.class)
                                   .getBody();
    ...
    public void findContentActivityList() {
        ...
        String json = restTemplate.exchange("/Content/V1/findContentActivityList/ALL?page=6&size=3", HttpMethod.GET
            , new HttpEntity(null,requestHeaders)
