...
public class EventContent implements Serializable {
	...
	@Column(name="ref_content_key")
	@ApiModelProperty(notes = "외부 컨텐츠 연결 일련번호" , hidden = true)
	private String refContentKey;
	...
	@Column(name="event_desc_text" , columnDefinition = "TEXT" )
	private String eventDescText;

	@ApiModelProperty(notes = "Event 상세의 이미지 정보",hidden = true)
	@Column(name="event_desc_thumbnails" , length=10000)
